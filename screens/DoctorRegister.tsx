                ...
                <V style={{flex: 1, alignItems: "center", justifyContent: "center", margin: 5, padding: 5, backgroundColor: "#fff"}}>
                        ...
                        <V style={styles.myStyle as StyleProp<ViewStyle>}>
                                <V style={{marginBottom: 10}}>
                                        <T style={{fontSize: 26, marginBottom: 24, color: "#3A5F0B", fontWeight: '300' }}>DOCTOR REGISTER</T> 
                        ...
                        <T style={{marginTop: 40, paddingBottom: 40}}>Own an Account, <T onPress={() => navigate('DoctorLogin')}>Please Login </T> </T>
                </V>
                </SV>
        )
}
