                ...
                <V style={{flex: 1, alignItems: "center", justifyContent: "center", margin: 5, padding: 5, backgroundColor: "#e6e6e6"}}>
                        ...
                        <V style={styles.myStyle as StyleProp<ViewStyle>}>
                                <V style={{marginBottom: 10}}>
                                        <T style={{fontSize: 26, marginBottom: 14, color: "navy" }}>DOCTOR REGISTER</T> 
                                        <T style={{marginBottom: 10, fontSize: 16, color: "#4d4d4d"}}>Smooth and easy patient automated system in health facilities</T>
                                </V>  
                                ...
                                <V style={{marginBottom: 20}}>      
                                        <SafeAreaView>
                                                ...
                                                />
                                                {errors.fullname && <T>This is required.</T>}
                                                <Controller 
                                                        control={control}
                                                        name="email"
                                                        render= {({field: {onChange, value, onBlur}}) => (
                                                ...
                                                />
                                                {errors.email && <T>This is required.</T>}
                                                <Controller 
                                                        control={control}
                                                        name="age"
                                                        render= {({field: {onChange, value, onBlur}}) => (
                                                ...
                                                />
                                                {errors.age && <T>This is required.</T>}
                                                <Controller 
                                                        control={control}
                                                        name="gender"
                                                        render= {({field: {onChange, value, onBlur}}) => (
                                                                ...
                                                                //         // }}
                                                                //         arrayList={[...genderData.list]}
                                                                // />
                                                        )}
                                                />
                                                {errors.gender && <T>This is required.</T>}
                                                <Controller 
                                                        control={control}
                                                        name="maritalStatus"
                                                        render= {({field: {onChange, value, onBlur}}) => (
                                                ...
                                                />
                                                {errors.maritalStatus && <T>This is required.</T>}
                                                <Controller 
                                                        control={control}
                                                        name="allergies"
                                                        render= {({field: {onChange, value, onBlur}}) => (
                                                ...
                                                />
                                                {errors.allergies && <T>This is required.</T>}
                                                <Controller 
                                                        control={control}
                                                        name="nextOfKin"
                                                        render= {({field: {onChange, value, onBlur}}) => (
                                                ...
                                                />
                                                {errors.nextOfKin && <T>This is required.</T>}
                                                <Controller 
                                                        control={control}
                                                        name="number"
                                                        render= {({field: {onChange, value, onBlur}}) => (
                                                ...
                                                />
                                                {errors.number && <T>This is required.</T>}
                                                <Controller 
                                                        control={control}
                                                        name="qualification"
                                                        render= {({field: {onChange, value, onBlur}}) => (
                                                ...
                                                />
                                                {errors.qualification && <T>This is required.</T>}
                                                <Controller 
                                                        control={control}
                                                        name="specialization"
                                                        render= {({field: {onChange, value, onBlur}}) => (
                                                ...
                                                />
                                                {errors.specialization && <T>This is required.</T>}
                                                <Controller 
                                                        control={control}
                                                        name="password"
                                                        render= {({field: {onChange, value, onBlur}}) => (
                                ...
                                {/* <V> */}
                                        ...
                                        <ButtonPaper onPress={handleSubmit(onSubmit)} mode="contained" disabled={loadingValue}>
