...
export const DoctorLogin = ({navigation: {navigate}}: any) => {
                ...
                <V style={{flex: 1, alignItems: "center", justifyContent: "center", margin: 5, padding: 5, backgroundColor: "#e6e6e6"}}>
                        ...
                        <V style={styles.myStyle as StyleProp<ViewStyle>}>
                                <V style={{marginBottom: 30}}>
                                        <T style={{fontSize: 26, marginBottom: 24, color: "navy" }}>DOCTOR LOGIN</T> 
                                        <T style={{marginBottom: 22, fontSize: 16, color: "#4d4d4d"}}>Smooth and easy doctor automated system in health facilities</T>
                                </V>  
