...
export const PatientRegister = ({navigation: {navigate}}: any) => {
                ...
                <V style={{flex: 1, alignItems: "center", justifyContent: "center", margin: 5, padding: 5, backgroundColor: "#e6e6e6"}}>
                        ...
                        <V style={styles.myStyle as StyleProp<ViewStyle>}>
                                <V style={{marginBottom: 10}}>
                                        <T style={{fontSize: 26, marginBottom: 14, color: "navy" }}>PATIENT REGISTER</T> 
                        ...
                        <T style={{marginTop: 40}}>Own an Account, <T onPress={() => navigate('PatientLogin')}>Please Login </T> </T>
                </V>
                </SV>
        )
}
